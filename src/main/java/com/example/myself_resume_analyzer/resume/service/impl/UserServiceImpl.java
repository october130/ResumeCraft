...
import com.example.myself_resume_analyzer.common.Result.ResultCode;
...
import com.example.myself_resume_analyzer.resume.mapper.UserMapper;
...
//        String password = encoder.encode(registerRequest.getPassword());//这个是密码加密后的密码，将密码加密后存储到数据库中
        String password = registerRequest.getPassword();//暂时先存储明文密码，后续再加密
